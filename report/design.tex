...
Justification for this choice is provided in \ref{section:mlsvm}. Some other methods which were considered are
denoted in \ref{section:mloptions}. The learning core was implemented as a Node.js RESTful API to make it easy for a
Mobile App or Web UI to consume on behalf of users of Gear Smarts. The API is described below in \ref{section:mlapi}.
